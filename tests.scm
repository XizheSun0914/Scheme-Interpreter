...
(define (make_adder x) (+ x 3)) (make_adder 5)
; expect 8
...
(define naturals (list 1 2 3 4 5 6 ))
...
(let ((a (lambda (a) (* a a))) (b 5)) (a b))
; expect 25

(define muproc (mu (x) (* x y) ))

(define lambdaproc (lambda (x y) (muproc (* x y))))

(lambdaproc 3 6)
; expect 108

(define alanturing (mu (mc) (* complete test mc)))
(define atm 
  (lambda (test complete)
    (alanturing
      (if (= complete test) 99999999 test))))
(atm 9999 9999)
